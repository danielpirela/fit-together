...
import { type SharedCompletion, getCellStatus, type DayOfWeek } from "@/core/entities";
    ...
    <div className={cn("overflow-x-auto", className)}>
      ...
      <div className="flex gap-4 mb-4 text-sm">
        <div className="flex items-center gap-2">
          <div className="flex">
            <div className="w-4 h-4 bg-green-primary" style={{ clipPath: "polygon(0 0, 100% 0, 0 100%)" }} />
            <div className="w-4 h-4 bg-purple-primary" style={{ clipPath: "polygon(100% 0, 100% 100%, 0 100%)" }} />
          </div>
